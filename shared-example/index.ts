/** Generated shared example functions from CDN/generateExcel ex*.html files */

export function ex0Dash0(factoryFunction?:(data:any)=>any):any {
    const data = {
        fileName: "ex0-0",
        sheet: [{}, {}, {}, {}],
    };
    if (typeof factoryFunction === "function") {
        return factoryFunction(data);
    }
    return data;
}

export function ex0Dashvalidator(factoryFunction?:(data:any)=>any):any {
    const data = {
        fileName: "ex0-0",
        sheet: [{}, {}, {}, {}],
    };
...
export function ex0(factoryFunction?:(data:any)=>any):any {
    const data = {
        fileName: "ex0",
    };
    if (typeof factoryFunction === "function") {
...
export function ex1Dash1(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: "MR Excel",
        fileName: "ex1-1",
        ...
        sheet: [
            {
                ...
                data: new Array(1_000_000).fill(0).map((v, ii) => ({ _id: ii, test: 'label' + (ii % 10) }))
            },
            {
                headers: [
                    {
...
export function ex1Dashvalidator(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: "MR Excel",
        fileName: "ex1-validator",
        created: "2023-08-06T07:22:40Z",
        modified: "2023-08-06T07:22:40Z",
        styles: {
            formulaStyle: {
...
export function ex1(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: "MR Excel",
        fileName: "ex1",
        created: "2023-08-06T07:22:40Z",
...
export function ex2Dash1(factoryFunction?:(data:any)=>any):any {
            const itemList = [
              {
                id: 7209449538085,
                name: "Tabitha",
        ...
        sheet: [
            {
                ...
                data: new Array(5_000_000).fill({}).map((_, index) => itemList[index % 9])
            },
            {
                state: "hidden",
                headers: [
...
export function ex2(factoryFunction?:(data:any)=>any):any {
    const data = {
        notSave: true,
        fileName: "ex2",
        creator: "MR Excel",
...
export function ex3(factoryFunction?:(data:any)=>any):any {
            const color = {
              c1: "08D9D6",
              c2: "252A34",
              c3: "FF2E63",
...
export function ex4(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2B2E4A",
        c2: "E84545",
        c3: "903749",
...
export function ex5(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2C3639",
        c2: "3F4E4F",
        c3: "A27B5C",
...
export function ex6(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: 'DBE2EF',
        c2: '112D4E',
        c4: 'F9F7F7'
...
export function ex7(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c4: 'FCD1D1',
        c2: 'AEE1E1'
    }
...
export function ex8(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c4: 'F08A5D',
        c2: 'F9ED69'
    }
...
export function ex9(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c4: '2B2E4A',
        c2: 'E84545'
    }
...
export function ex10(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c4: 'FFC7C7',
        c2: '8785A2'
    }
      ...
      sheet: [
        {
          ...
          styleCellCondition(
            ...
            if (fromHeader) {
              ...
              if (colIndex - 5 == 0 && data < 0.3) {
                return "c0<0.3";
              } else if (colIndex - 5 == 3) {
                if (data) {
                  return "male";
                } else {
                  return "female";
...
export function ex11(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c4: 'FFC7C7',
        c2: '8785A2'
    }
      ...
      sheet: [
        {
          ...
          styleCellCondition(
            ...
            if (fromHeader) {
              ...
              if (colIndex - 1 == 0 && data < 0.3) {
                return "c0<0.3";
              } else if (colIndex - 1 == 3) {
                if (data) {
                  return "male";
                } else {
                  return "female";
...
export function ex14(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c4: '61677A',
        c2: 'FFF6E0'
    }
...
export function ex15Dash1(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c4: "F7E987",
        c2: "5B9A8B",
    };
      ...
      sheet: [
        {
          multiStyleCondition(
            ...
            if (fromHeader) {
              let sp = data.text.split("");
              sp = sp.reduce(
                (result: any, current: any, index: any) => [
                  ...result,
                  {
                    value: current,
                    styleId: index % 2 == 0 ? "headC1" : "headC2",
                  },
                ],
                [],
              );
              ...
              sp = sp.reduce(
                (result: any, current: any, index: any) => [
                  ...
                  {
                    value: current,
                    styleId: index % 2 == 0 ? "bodyC1" : "bodyC2",
                  },
                ],
                [],
              );
...
export function ex15(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c2: "5B9A8B",
        c4: "F7E987",
    };
...
export function ex16(factoryFunction?:(data:any)=>any):any {
    ...
    const data = {
      ...
      styles: {
        ...
        t2: { color: "F08A5D", size: 22 },
        t1: { color: "555555", size: 22 },
        "c0<0.3": {
          backgroundColor: "DCD6F7",
          color: "424874",
          ...alignLeft,
      ...
      sheet: [
        {
          ...
          multiStyleCondition: function (
            ...
            let charList = (fromHeader ? data.text : data).split("");
            return charList.reduce((result: any, current: any, index: any) => {
              let styleId = index % 2 ? "col1" : "col2";
              result.push({
                value: current,
                styleId,
              });
          ...
          headers: [
            {
              label: "c1",
              text: "**",
              comment: { author: "MR Excel", comment: "misspell in header" },
            },
            { label: "c2", text: "++" },
            {
              label: "c3",
...
export function ex17(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: 'MR Excel',
        fileName: "ex17",
        sheet: [
...
export function ex18(factoryFunction?:(data:any)=>any):any {
    const data = {
...
export function ex19(factoryFunction?:(data:any)=>any):any {
    const data = {
        activateConditionalFormatting: true,
        creator: 'MR Excel',
        fileName: "ex19",
...
export function ex20(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: 'MR Excel',
        fileName: "ex20",
        activateConditionalFormatting: true,
...
export function ex21(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: 'MR Excel',
        fileName: "ex21",
        sheet: [
...
export function ex22(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2C3639",
        c2: "3F4E4F",
        c3: "A27B5C",
    ...
    const data = {
        ...
        styles: {
            ...
            Date: { ...rowStyle, format: "short_date" },
            customFormulaStyle: {
...
// TODO:example not complete
export function ex23(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '2C3639',
        c2: '3F4E4F',
        c3: 'A27B5C',
...
export function ex24(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: 'MR Excel',
        fileName: "ex24",
        sheet: [
...
export function ex25(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex26(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex27(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex28(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex29(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex30(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex31(factoryFunction?:(data:any)=>any):any {
...
export function ex32(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex33(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex34(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex35(factoryFunction?:(data:any)=>any):any {
...
export function ex36(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
    ...
    const data = {
        ...
        sheet: [
            {
                backgroundImage: "https://mohammadrezaeicode.github.io/mr-excel-page/img/logo.png",
                headers: [
                    { label: "id", text: "ID" },
                    { label: "name", text: "Name" },
                    { label: "surname", text: "Surname" },
...
export function ex37(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: '561C24',
        c2: '6D2932',
        c3: 'C7B7A3',
...
export function ex38(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: 'MR Excel',
        fileName: "ex38",
        sheet: [
...
export function ex39(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: 'MR Excel',
        fileName: "ex39",
        sheet: [
...
export function ex40(factoryFunction?:(data:any)=>any):any {
    const data = {
        creator: 'MR Excel',
        fileName: "ex40",
        sheet: [
...
export function ex42(factoryFunction?:(data:any)=>any):any {
    const data = {
        // notSave: true,
        creator: 'MR Excel',
        fileName: "ex42",
        created: "2023-08-10T10:00:00Z",
        modified: "2023-08-10T12:30:00Z",
        numberOfColumn: 5,
        createType: "custom",
        styles: {
            headerStyle1: {
...
export function ex43(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2B2E4A",
        c2: "E84545",
        c3: "903749",
...
export function ex44(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2B2E4A",
        c2: "E84545",
        c3: "903749",
...
export function ex45(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2B2E4A",
        c2: "E84545",
        c3: "903749",
...
export function ex46Dash1(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2B2E4A",
        c2: "E84545",
        c3: "903749",
...
export function ex46(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2B2E4A",
        c2: "E84545",
        c3: "903749",
...
export function ex47(factoryFunction?:(data:any)=>any):any {
    const colorPalette = {
        c1: "2B2E4A",
        c2: "E84545",
        c3: "903749",
